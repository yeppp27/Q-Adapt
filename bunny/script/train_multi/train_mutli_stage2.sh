...
MODEL_TYPE=phi-2
MODLE_STAGE1='VLM_weight_output/lora_co_instruct_230k/'
PRETRAIN_DIR='Bunny-v1_0-3B'
OUTPUT_DIR='qformer_stage2_multiiamges'
mkdir -p VLM_weight_output/q-adapt/checkpoints-$MODEL_TYPE/$OUTPUT_DIR

nohup deepspeed --master_port 28802 --include localhost:0,1,2,3 bunny/train/train_multiimages_addqformer_stage2.py \
    ...
    --version bunny \
    --data_path data/co-instruct/co_instruct_330k.json \
